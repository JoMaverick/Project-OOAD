...
public class MenuItemManage extends Application {
	...
	private ObservableList<User> menuItems = FXCollections.observableArrayList();
	private TableView<User> table;
	
	private void loadMenuItemData() {
		List<User> data = UserController.getAllUsersController();
	...
	private void setupTableSelectionListener() {
        table.getSelectionModel().selectedItemProperty().addListener((obs, oldSelection, newSelection) -> {
            if (newSelection != null) {
                ...
                roleInput.setText(String.valueOf(newSelection.getUserRole()));
                nameInput.setText(String.valueOf(newSelection.getUserName()));
                emailInput.setText(String.valueOf(newSelection.getUserEmail()));
                passInput.setText(String.valueOf(newSelection.getUserPassword()));
            }
        });
    }
	...
	public void start(Stage primaryStage) {
        ...
        GridPane form = createProductTable(table);
